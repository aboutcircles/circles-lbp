...
contract BaseTestContract is Test {
    ...
    function setUp() public {
        ...
        _setCRCBalance(uint256(uint160(TEST_ACCOUNT_1)), TEST_ACCOUNT_1, HUB_V2.day(block.timestamp), uint192(CRC_AMOUNT * 2));
        _setCRCBalance(uint256(uint160(TEST_ACCOUNT_2)), TEST_ACCOUNT_2, HUB_V2.day(block.timestamp), uint192(CRC_AMOUNT * 2));
