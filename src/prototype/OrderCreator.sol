...
contract OrderCreator {
    ...
    string public constant postAppData =
        '","callData":"0xbb5ae136","gasLimit":"200000"}]}}}'; // Updated calldata for checkOrderFilledAndTransfer
    ...
    function getAppData(address _newAccount) public pure returns (bytes32) {
        ...
        string memory _appDataStr = string.concat(
            preAppData,
            _newAccountStr,
            postAppData
        );
